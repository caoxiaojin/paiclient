...
<div>
  <el-breadcrumb separator-class="el-icon-arrow-right">
    ...
    <el-breadcrumb-item>deployment管理</el-breadcrumb-item>
  </el-breadcrumb>
  <el-card>
    <el-row :gutter="20">
...
export default {
  ...
  methods: {
    ...
    async getdeploymentList () {
      const { data: res } = await this.$http.get(`container/control?control=deployment&cluster=${this.cluster}&namespace=${this.namespace}`)
      if (res.code !== 200) return this.$message.error(res.msg)
